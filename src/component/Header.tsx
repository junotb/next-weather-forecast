  ...
  return (
    <header className="fixed top-0 left-0 flex justify-between items-center border-b border-gray-400 px-4 py-2 w-full h-16">
      ...
      <div className="flex space-x-2">
        <button className="border border-gray-700 px-4 py-2 hover:bg-gray-200 rounded-sm" onClick={fetchFcst}>날씨 정보 불러오기</button>
        <button className="border border-gray-700 px-4 py-2 hover:bg-gray-200 rounded-sm">그리기</button>
      </div>
    </header>
  );
}